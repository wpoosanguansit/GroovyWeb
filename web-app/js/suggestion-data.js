...
var cities = [
    ...
    "Anchorage","Ann Arbor","Arlington CDP","Arlington","Atlanta","Aurora","Austin","Bakersfield",
    "Baltimore","Baton Rouge","Beaumont","Berkeley","Birmingham","Boise","Boston","Bridgeport",
    "Buffalo","Cedar Rapids","Charlotte","Chattanooga","Chesapeake","Chicago","Chula Vista",
    "Cincinnati","Citrus Heights CDP","Cleveland","Colorado Springs","Columbus","Columbus","Concord",
    "Corpus Christi","Dallas","Dayton","Denver","Des Moines","Detroit","Durham","East Los Angeles CDP",
    "El Monte","El Paso","Elizabeth","Erie","Escondido","Eugene","Evansville","Flint","Fort Lauderdale",
    "Fort Wayne","Fort Worth","Fremont","Fresno","Fullerton","Garden Grove","Garland","Gary","Glendale",
    "Glendale","Grand Rapids","Greensboro","Hampton","Hartford","Hayward","Hialeah","Hollywood",
    "Honolulu CDP","Houston","Huntington Beach","Huntsville","Independence","Indianapolis","Inglewood",
    "Irvine","Irving","Jackson","Jacksonville","Jersey","Kansas","Kansas","Knoxville","Lakewood","Lansing",
    "Laredo","Las Vegas","Lexington-Fayette","Lincoln","Little Rock","Livonia","Long Beach","Los Angeles",
    "Louisville","Lowell","Lubbock","Macon","Madison","Memphis","Mesa","Mesquite","Metairie CDP","Miami",
    "Milwaukee","Minneapolis","Mobile","Modesto","Montgomery","Moreno Valley","Nashville-Davidson",
    "New Haven","New Orleans","New York","Newark","Newport News","Norfolk","Oakland","Oceanside","Oklahoma",
    "Omaha","Ontario","Orange","Orlando","Overland Park","Oxnard","Paradise CDP","Pasadena","Pasadena",
    "Paterson","Peoria","Philadelphia","Phoenix","Pittsburgh","Plano","Pomona","Portland","Portsmouth",
    "Providence","Raleigh","Rancho Cucamonga","Reno","Richmond","Riverside","Rochester","Rockford","Sacramento",
    "Salem","Salinas","Salt Lake","San Antonio","San Bernardino","San Diego","San Francisco","San Jose",
    "Santa Ana","Santa Clarita","Santa Rosa","Savannah","Scottsdale","Seattle","Shreveport","Simi Valley",
    "Sioux Falls","South Bend","Spokane","Springfield","Springfield","Springfield","Stamford","Sterling Heights",
    "Stockton","St. Louis","St. Paul","St. Petersburg","Sunnyvale","Syracuse","Tacoma","Tallahassee",
    "Tampa","Tempe","Thousand Oaks","Toledo","Topeka","Torrance","Tucson","Tulsa","Vallejo","Virginia Beach",
    "Waco","Warren","Washington","Waterbury","Wichita","Winston-Salem","Worcester","Yonkers",
    "London","Berlin","Madrid","Rome","Paris","Bucharest","Hamburg","Warsaw","Budapest","Vienna",
    "Barcelona","Sofia","Munich","Milan","Prague","Birmingham","Cologne","Naples","Turin","Marseille",
    "Stockholm","Valencia","Leeds","Kraków","Łódź","Amsterdam","Athens","Riga","Seville","Frankfurt","Zaragoza",
    "Palermo","Wrocław","Copenhagen","Genoa","Stuttgart","Dortmund","Rotterdam","Essen","Glasgow","Helsinki",
    "Düsseldorf","Málaga","Poznań","Vilnius","Bremen","Sheffield","Hannover","Leipzig","Dresden","Dublin",
    "Nuremberg","Gothenburg","Duisburg","Lisbon","Bradford","The Hague","Lyon","Edinburgh","Antwerp","Manchester",
    "Gdańsk","Toulouse","Liverpool","Murcia","Bratislava","Bristol","Szczecin","Palma","Tallinn","Bochum",
    "Las Palmas","Plovdiv","Bologna","Brno","Florence","Thessaloniki","Bydgoszcz","Varna","Kaunas","Wuppertal",
    "Bilbao","Lublin","Nice","Ostrava","Alicante","Bielefeld","Córdoba","Wakefield","Cardiff","Bari","Valladolid",
    "Iaşi","Katowice","Bonn","Cluj-Napoca","Timişoara","Mannheim","Coventry","Constanţa",
    "Bangalore","Bangkok","Beijing","Bengkulu City","Bishkek","Bukhara","Bursa","Cairo",
    "Chengdu","Chennai","Chittagong","Chongqing","Damascus","Da Nang","Dhaka","Dushanbe","Erzurum",
    "Faisalabad","Guangzhou","Haifa","Hebron","Ho Chi Minh City","Hong Kong","Hyderabad","Hyderabad - Pakistan",
    "Irkutsk","Iskenderun","Izmir","Jakarta","Jericho","Jeddah","Jerusalem","Karachi","Kayseri","Kolkata",
    "Kota Kinabalu","Kuala Lumpur","Kyoto","Latakia","Lucknow","Macau","Makassar","Malacca","Manila","Mecca",
    "Medina","Mumbai","","Nablus","New Delhi","Nicosia","","Osaka","","Pyongyang","","Sahiwal","Samarkand",
    "Seoul","Singapore","Tashkent","Tehran","Tokyo","Trabzon","Ulan Bator","Vientiane","Yekaterinburg","Yerevan",    
...
var states = [ "Alabama ", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut",
    "Delaware", "District of Columbia (DC)", "Florida", "Georgia", "Guam", "Hawaii", "Idaho", "Illinois",
    ...
    "Nova Scotia",  "Nunavut",  "Prince Edward Island", "Saskatchewan", "Ontario", "Quebec", "Yukon",
    "Aguascalientes", "Baja California Norte", "Baja California Sur", "Campeche", "Chiapas", "Chihuahua", "Coahuila",
    "Colima", "Distrito Federal", "Durango", "Guanajuato", "Guerrero", "Hidalgo", "Jalisco",
    "México - Estado de", "Michoacán", "Morelos", "Nayarit", "Nuevo León", "Oaxaca", "Puebla", "Querétaro", "Quintana Roo",
    "San Luis Potosí", "Sinaloa", "Sonora", "Tabasco", "Tamaulipas", "Tlaxcala", "Veracruz", "Yucatán", "Zacatecas", "Other", "NA"    
];

var charityOrganizations = ["Red Cross", "NRP Public Radio"];