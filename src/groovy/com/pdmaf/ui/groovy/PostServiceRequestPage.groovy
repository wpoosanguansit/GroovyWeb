...
public class PostServiceRequestPage extends MainPage {
  ...
  def protected secondaryHeaderInclude = {
   ...
   def protected pageBodyMainContent = {
       ...
       div(class: 'span-20 prepend-2') {
           mkp.yieldUnescaped("""
								<form action="${url}serviceRequest/postServiceRequest" method="POST" class="normalform" id="service-request-form">
									<p>Please complete the form below. Mandatory fields marked <em>*</em></p>
									<fieldset>
										<legend>Service Request</legend>
										<ol>
											<li><label for="name">Posting Title : <em>*</em></label> <input id="postingtitle" name="title" class="field text"  title="Short description of service needed..." tabindex="1"/><span id="postingtitle-checkmark"></span></li>
											<li><label for="address">Specific Location : <em>*</em></label> <input id="location" name="location" class="field text" title="Neighborhood, anywhere, online, etc..." tabindex="2"/><span id="location-checkmark" ></span></li>
											<li><label for="city">City : <em>*</em></label> <input id="city" name="city" class="field text" title="City where you are located..." tabindex="3"/><span id="city-checkmark" ></span></li>
											<li><label for="state">State : <em>*</em></label> <input id="state" name="state" class="field text" title="State where you are located..." tabindex="4"/><span id="state-checkmark" ></span></li>
											<li><label for="county">Country : <em>*</em></label> <select id="country" name="country" tabindex="5"><optgroup label="">
												...
												<li>
													  ...
													  <span>
														  <input id="email1" name="email1" type="text" class="field text" title="Valid email address..." value="" size="25" tabindex="7" />
													 </span>
                                                </li>
                                                <li>
                                                     <label class="desc">
													  ...
													  <span>
														  <input id="email2" name="email2" type="text" class="field text" title="Please confirm your email..." value="" size="25" tabindex="8" />
													  </span>
												...
												<li>
													...
													<label title="Email will be anonymized">
														...
														<br>e.g. <a href="#">service-request-xxx@pdmaf.com</a>
													</label>
                                                    </div>
												</li>
												<li><label for="category">Category : <em>*</em></label> <input id="category" name="category" class="field text"  title="Suggested category..." tabindex="12"/><span id="category-checkmark"></span></li>
												<li><label for="description">Full Description : <em>*</em></label>
												<textarea id="description" name="description" class="field text"  value= "" title="Full service request description.  It has to be at least 20 characters or more..." tabindex="13" ></textarea>
												...
												<li>
                                                 ...
                                                 <li>
                                                    <div id="pointsoffered" style="display: none;">
                                                        ...
                                                        <span>
                                                          <input name="pointsoffered" type="text" class="field text" title="Points you would like to offer..." value="" size="25" tabindex="17" />
                                                        </span>
                                                    </div>
                                                    <div id="compensationdescription" style="display: none;">
                                                        ...
                                                        <span>
                                                          <textarea cols="40" rows="5" name="othercompensation" type="text" class="field text" title="Please be specific how you would like to compensate the service provider..." value="" size="100" tabindex="17" ></textarea>
                                                        </span>
                                                    </div>
                                                </li>
										</ol>
									</fieldset>
									<p><input class="button" type="submit" id="submitservicerequest" value="Submit Service Request" tabindex="18"/></p>
								</form>
                             """)
                        }
