...
import com.pdmaf.ui.gwt.client.exceptions.TimeoutException;
...
public class JsonpRequest<T> {
  ...
  private native void registerCallbacks(JavaScriptObject callbacks) /*-{
    ...
    callbacks[this.@com.pdmaf.ui.gwt.client.rpc.JsonpRequest::callbackId] = callback;
    callback.onSuccess = function(data) {
      // Box primitive types
      if (typeof data == 'boolean') {
        data = @java.lang.Boolean::new(Z)(data);
      } else if (typeof data == 'number') {
        if (self.@com.pdmaf.ui.gwt.client.rpc.JsonpRequest::expectInteger) {
          data = @java.lang.Integer::new(I)(data);
        } else {
          data = @java.lang.Double::new(D)(data);
        }
      }
      self.@com.pdmaf.ui.gwt.client.rpc.JsonpRequest::onSuccess(Ljava/lang/Object;)(data);
    };
    if (this.@com.pdmaf.ui.gwt.client.rpc.JsonpRequest::failureCallbackParam) {
      callback.onFailure = function(message) {
        self.@com.pdmaf.ui.gwt.client.rpc.JsonpRequest::onFailure(Ljava/lang/String;)(message);
      };
    }
  }-*/;
  ...
  private native void unregisterCallbacks(JavaScriptObject callbacks) /*-{
    delete callbacks[this.@com.pdmaf.ui.gwt.client.rpc.JsonpRequest::callbackId];
  }-*/;
}
